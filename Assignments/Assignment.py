...
print('This tool helps you to track your daily total calories and compares it with your calorie limit.')


n=int(input('Enter the consumed amount of meal'))
...
for i in range(1,n+1):
    ...
    meal.append(mn)
    calorie.append(ca)
    total_calories_intake=sum(calorie)
    average_cal_per=sum(calorie)/n
    if total_calories_intake>=limit:
...
print("--------------------------------------------")
print(f"Total:               {total_calories_intake}")
